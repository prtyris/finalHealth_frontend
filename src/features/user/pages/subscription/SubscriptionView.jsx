...
const SubscriptionView = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "₱499",
      features: [
        "Up to 5 out of record",
        "Able to Lock 100 patients",
        "Cancel anytime",
      ],
      featured: true,
    },
  ...
  const handleActivateFreeTrial = () => {
    ...
    showSuccessModal(
      ...
      "Your free trial has been successfully activated. You can now start using FinalHealth!"
    );
  };
        ...
        <div className="w-full max-w-6xl">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-2xl mx-auto">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded">
                <p className="text-blue-800 text-sm">
                  To continue your subscription, please verify that you're a
                  licensed doctor or an authorized medical secretary.
                </p>
              </div>
              ...
              <p className="text-gray-600 mb-6">
                Upload your PRC license (for doctors) or employment
                ID/certificate (for secretaries)
              </p>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("verificationId", e.target.value)
                    }
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                    required
                  />
                ...
                <p className="text-gray-500 text-sm">
                  ℹ️ We will not share, not use nor BLAST all verification
                  purposes and will comply confidentiality
                </p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <label className="flex items-start">
                    ...
                    <span className="ml-3 text-sm text-gray-700">
                      ...
                      and authorize payment for this subscription
                    </span>
                  </label>
                </div>
          ...
          {currentStep === 4 && (
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-2xl mx-auto">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded">
                <p className="text-blue-800 text-sm">
                  Get access to 3 out of record and start using FinalHealth for
                  free!
                </p>
              </div>

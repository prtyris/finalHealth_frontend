  ...
  if (error) {
    return (
      <div style={{
        ...
        <h2 style={{color: '#7f1d1d', marginBottom: '10px'}}>Error Loading Profile</h2>
    ...
    <div className="personal-info-container">
      ...
      <div style={{
        ...
        <p>
          ...
          Your information is secured with end-to-end encryption • Last updated: {new Date().toLocaleDateString()}
        </p>
      </div>
    </div>
  );

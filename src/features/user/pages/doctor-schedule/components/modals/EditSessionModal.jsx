...
const EditSessionModal = ({ isOpen, onClose, onSubmit, darkMode, sessionData }) => {
  const [formData, setFormData] = useState({
    clinic: sessionData?.clinic === 'CityHealth Clinic' ? 'cityhealth' : 'medicare' || '',
    dayOfWeek: sessionData?.day.toLowerCase() || 'monday',
    sessionType: sessionData?.sessionType || 'morning',
